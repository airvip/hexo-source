...
Python 官方提供了一系列的 PEP (Python Enhancement Proposals) 文档，其中第 8 篇文章专门针对 **Python 的代码格式** 给出了建议，也就是大家常说的 PEP8 。

<!-- more -->

[PEP8 官方文档入口](https://www.python.org/dev/peps/pep-0008/)

规范的编码习惯可以提高代码的可维护性，也是我们编程的第一步。

下面我们来看下[ google 对 Python 编码](https://google.github.io/styleguide/pyguide.html) 如何规范的吧！
...
Python会将 [圆括号, 中括号和花括号中的行隐式的连接起来](https://docs.python.org/reference/lexical_analysis.html#implicit-line-joining) , 你可以利用这个特点. 如果需要, 你可以在表达式外围增加一对额外的圆括号.
...
推荐使用 [“with”](http://docs.python.org/reference/compound_stmts.html#the-with-statement)语句 以管理文件:
``` Python
...
[原文翻译传送门](http://zh-google-styleguide.readthedocs.io/en/latest/google-python-styleguide/python_style_rules/)